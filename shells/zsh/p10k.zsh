# Generated by Powerlevel10k configuration wizard on 2023-05-05 at 16:57 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k|kz|kubectl|kustomize|helm|kubens|kubectx|k9s|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubent|kubecolor|kubeseal|skaffold'
  ...
  # typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|asp|awless|terraform|pulumi|terragrunt'
  ...
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=130
