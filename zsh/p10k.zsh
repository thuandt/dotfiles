# Generated by Powerlevel10k configuration wizard on 2026-07-28 at 01:14 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=028
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k|kubectl|kz|kustomize|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl'
  ...
  # Production cluster: Red background with bright white text
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=15
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=160

  # Default/NonProd cluster: Cyan/Teal background with bright white text
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=15
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=31
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|asp|awless|cdk|terraform|tofu|pulumi|terragrunt|sops'
  ...
  # Production AWS profile: Red background with bright white text
  typeset -g POWERLEVEL9K_AWS_PROD_FOREGROUND=15
  typeset -g POWERLEVEL9K_AWS_PROD_BACKGROUND=160

  # Default AWS profile: Bright Orange background with bright white text
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=15
